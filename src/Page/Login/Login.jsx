...
export default function Login() {
    ...
    // console.log(UserLogin, "đã lấy thành công")
    ...
    return (
        <Fragment>
            <h1 className='title_login'>CHÀO MỪNG BẠN ĐẾN VỚI GALAXY CINEMA</h1>
            <div className="login">
                ...
                <div className='login_right'>
                    ...
                    <form onSubmit={formik.handleSubmit} className='form_login'>
                        ...
                        <div className='button_login'>
                            ...
                            <NavLink to="/">
                                <button type='button' className='btn btn-success'>Quay Lại Trang Chủ</button>
                            </NavLink>
                        </div>
                    </form>
                </div>
