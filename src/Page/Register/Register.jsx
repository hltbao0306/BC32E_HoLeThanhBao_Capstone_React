...
export default function Register() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            taiKhoan: Yup.string().required("Tài khoản không được để trống").min(6, "Tối thiểu đủ 6 kí tự").max(10, "Tối đa 10 kí tự"),
    ...
    return (
        <Fragment>
            <h1 className='title_register'>CHÀO MỪNG BẠN ĐẾN VỚI GALAXY CINEMA</h1>
            <div className="Rigister">
                ...
                <div className='Rigister_right'>
                    <div className="right_top">
                        ...
                        <h1>NƠI THỎA SỨC ĐAM MÊ VỚI CÁC CỐT TRUYỆN LÔI CUỐN VÀ ĐẦY HẤP DẪN</h1>
                    </div>
